#!/bin/bash
# USB gadget networking for ODROID Go Ultra
# Creates an ECM ethernet gadget on the USB-C port for headless SSH access
...
gadget=/sys/kernel/config/usb_gadget/ogu
